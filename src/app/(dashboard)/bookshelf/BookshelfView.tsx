...
export default function BookshelfView({
  ...
  useEffect(() => {
    ...
    if (tabParam === 'art' && profileIdParam) {
      setActiveTab({ [profileIdParam]: 'art' })
    }
  }, [searchParams])
  ...
  function getTab(profileId: string): 'books' | 'art' {
    return activeTab[profileId] ?? 'books'
  }
  function setTab(profileId: string, tab: 'books' | 'art') {
    setActiveTab(prev => ({ ...prev, [profileId]: tab }))
  }
        ...
        return (
          <div key={profile.id} className="mb-10">
            ...
            <div className="flex gap-2 mb-3">
              <button
                onClick={() => setTab(profile.id, 'books')}
