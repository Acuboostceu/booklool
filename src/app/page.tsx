...
const copy = {
  en: {
    ...
    hero_title: "Your family's reading story,",
    hero_title2: 'beautifully preserved.',
    hero_sub: "Snap a photo, log the book, write a thought. At year's end, turn it all into a printed keepsake your family will treasure forever.",
  ...
  ko: {
    ...
    lang_toggle: 'English',
    hero_tag: '📚 가족 독서 일기',
    hero_title: '우리 가족의 독서 이야기를',
    hero_title2: '아름답게 기록해요.',
    hero_sub: '책 표지를 찍고, 기록하고, 생각을 남겨요. 연말엔 그 모든 순간을 담은 책 한 권이 집으로 배달돼요.',
    hero_cta: '무료로 시작하기',
